...
Validate that Library supports the intended user journeys, handles empty states correctly, and calls interaction callbacks with the right payloads.
...
**Scenario:** Browse the Library by Series and/or Topics to discover teachings
...
**Steps:**
1. User navigates to the Library route
...
**Scenario:** Open a Series to view its sermons, then filter/sort within the list
...
**Scenario:** Search across titles, summaries, scripture references, and transcripts/notes to find a specific teaching
