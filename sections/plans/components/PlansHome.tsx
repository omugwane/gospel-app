  ...
  return (
    <div className="w-full min-h-screen">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 py-6 sm:py-8">
          ...
          {FILTERS.map(({ id, label, icon: Icon }) => (
            <button
              ...
              className={cn(
                ...
                activeFilter === id
                  ? 'bg-violet-600 text-white shadow-md shadow-violet-500/20 dark:shadow-violet-400/10'
                  : 'bg-white/70 dark:bg-stone-950/50 border border-stone-200/80 dark:border-stone-800/80 text-stone-700 dark:text-stone-300 hover:bg-stone-50 dark:hover:bg-stone-900 hover:border-stone-300 dark:hover:border-stone-700'
              )}
            >
        ...
        {activeFilter === 'find' && (
          <div className="mb-4">
            <div className="rounded-2xl border border-stone-200/80 dark:border-stone-800/80 bg-white/70 dark:bg-stone-950/50 px-4 py-3 flex items-center gap-3">
              ...
              <input
                ...
                className="flex-1 min-w-0 bg-transparent outline-none text-sm text-stone-900 dark:text-stone-100 placeholder:text-stone-400"
              />
            </div>
          </div>
        )}
        ...
        {filteredPlans.length === 0 ? (
          <div className="rounded-2xl border border-stone-200/80 dark:border-stone-800/80 bg-white/60 dark:bg-stone-950/40 p-8 sm:p-12 text-center">
            <div className="mx-auto w-14 h-14 rounded-2xl bg-stone-100 dark:bg-stone-800 flex items-center justify-center mb-4">
              <LayoutList className="h-7 w-7 text-stone-500 dark:text-stone-400" strokeWidth={1.5} />
            </div>
            ...
            <p className="mt-2 text-sm text-stone-600 dark:text-stone-400 max-w-sm mx-auto">
