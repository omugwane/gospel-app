...
Validate that Giving supports the intended user journeys, handles empty states correctly, and calls interaction callbacks with the right payloads.
...
**Scenario:** User opens Giving, watches a short "Heart of Giving" video, and chooses an impact category (e.g., Prophetic Mission Fund, Family Connection Media, General Tithe & Offering).
...
**Steps:**
1. User navigates to the Giving route
...
**Scenario:** User completes a three-step giving wizard: select amount (preset or custom), choose category, then choose payment method (MoMo or global card/wallet).
...
**Scenario:** User chooses one-time or recurring giving and can optionally give anonymously.
