...
Validate that Home supports the intended user journeys, handles empty states correctly, and calls interaction callbacks with the right payloads.
...
**Scenario:** Open Home and immediately see a contextual greeting plus Daily Manna (Verse of the Day and short Imbuguro audio)
...
**Steps:**
1. User navigates to the Home route
...
**Scenario:** Share the Verse of the Day to WhatsApp in one tap
...
**Scenario:** Start the daily Imbuguro directly from the hero section
