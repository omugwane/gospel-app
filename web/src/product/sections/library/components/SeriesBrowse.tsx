    ...
    return (
      <button
        ...
        className={cn(
          ...
          'hover:bg-white/90 dark:hover:bg-neutral-950/70',
        ...
        <div className="shrink-0 flex items-center gap-2">
          <button
            ...
            className={cn(
              ...
              isSaved
                ? 'bg-primary-600/15 dark:bg-primary-400/15 text-primary-700 dark:text-primary-200'
          ...
          <ArrowRight className="h-4 w-4 text-neutral-400 dark:text-neutral-500 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors" strokeWidth={1.75} />
        </div>
      </button>
    )
  }
