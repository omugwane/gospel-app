    ...
    <div className="w-full min-h-[80vh] flex flex-col">
      <div className="mx-auto max-w-5xl w-full flex-1 flex flex-col">
          ...
          <div className="w-full md:max-w-md">
            <div className="rounded-2xl border border-neutral-200/70 dark:border-neutral-800/70 bg-white/70 dark:bg-neutral-950/40 px-3 py-2 flex items-center gap-2">
              ...
              <button
                ...
                className="rounded-xl bg-primary-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-primary-700 transition-colors shrink-0"
              >
                Search
              </button>
            </div>
        ...
        <section className="mt-8 sm:mt-12 flex-1 flex flex-col justify-center">
          <div className="relative overflow-hidden rounded-3xl border border-neutral-200/70 dark:border-neutral-800/70 bg-white/70 dark:bg-neutral-950/50 shadow-sm">
            ...
            <div className="relative px-6 py-12 sm:px-10 sm:py-16 text-center">
              <div className="inline-flex items-center justify-center h-16 w-16 sm:h-20 sm:w-20 rounded-2xl bg-neutral-100 dark:bg-neutral-900 mb-6">
                <Search className="h-8 w-8 sm:h-10 sm:w-10 text-neutral-500 dark:text-neutral-400" strokeWidth={1.5} />
              </div>
              <h2 className="text-xl sm:text-2xl font-semibold tracking-tight text-neutral-950 dark:text-neutral-50">
                No matches found
              </h2>
              <p className="mt-3 max-w-md mx-auto text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
                {query.trim()
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
                <button
                  type="button"
                  onClick={resetAll}
                  className="inline-flex items-center gap-2 rounded-xl border border-neutral-200/70 dark:border-neutral-800/70 bg-white/60 dark:bg-neutral-950/40 px-4 py-2.5 text-sm font-semibold text-neutral-900 dark:text-neutral-100 hover:bg-neutral-50 dark:hover:bg-neutral-900 transition-colors"
                >
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {recentQueries.slice(0, 3).map((q) => (
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-xl bg-primary-600/10 dark:bg-primary-400/10 px-3 py-2 text-xs font-semibold text-primary-900 dark:text-primary-100 hover:bg-primary-600/15 dark:hover:bg-primary-400/15 transition-colors"
                      >
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <button
              type="button"
              onClick={() => onOpenSeries?.(data.series[0]?.id ?? '')}
              className="rounded-2xl border border-neutral-200/70 dark:border-neutral-800/70 bg-white/60 dark:bg-neutral-950/40 p-5 text-left hover:bg-white/80 dark:hover:bg-neutral-950/60 transition-colors group"
            >
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-xl bg-primary-600/10 dark:bg-primary-400/10 flex items-center justify-center group-hover:bg-primary-600/15 dark:group-hover:bg-primary-400/15 transition-colors">
                  <Sparkles className="h-5 w-5 text-primary-700 dark:text-primary-200" strokeWidth={1.75} />
                </div>
                <div className="min-w-0">
            ...
            >
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-xl bg-secondary-50 dark:bg-secondary-500/10 flex items-center justify-center group-hover:bg-secondary-100/70 dark:group-hover:bg-secondary-500/15 transition-colors">
                  <Tag className="h-5 w-5 text-secondary-800 dark:text-secondary-200" strokeWidth={1.75} />
                </div>
                <div className="min-w-0">
                  <div className="text-sm font-semibold text-neutral-950 dark:text-neutral-50">
                    Browse by topic
          ...
          {hasAnyFilter && (
            <div className="mt-6 rounded-2xl border border-secondary-200/70 dark:border-secondary-500/30 bg-secondary-50/80 dark:bg-secondary-500/10 p-4">
              <div className="flex items-start gap-3">
                <Filter className="h-5 w-5 text-secondary-700 dark:text-secondary-200 shrink-0 mt-0.5" strokeWidth={1.75} />
                <div className="min-w-0">
                  ...
                  <button
                    type="button"
                    onClick={resetAll}
                    className="mt-3 text-xs font-semibold text-secondary-800 dark:text-secondary-200 hover:underline"
                  >
                    Clear all filters
                  </button>
                </div>
        ...
        <div className="mt-8 pt-6 border-t border-neutral-200/70 dark:border-neutral-800/70">
          <div className="flex flex-wrap items-center gap-2">
            <span className="text-[11px] font-semibold text-neutral-500 dark:text-neutral-400">
              Filters:
            </span>
